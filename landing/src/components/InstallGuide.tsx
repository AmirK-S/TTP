...
export function InstallGuide({ translations, windowsDownloadUrl }: InstallGuideProps) {
  const t = {
    ...
    whyText: translations?.whyText ?? "TTP is free and source-available. Apple and Microsoft charge developers hundreds of dollars per year for a certificate that removes security warnings. We chose to keep TTP free instead. The app is fully source-available: you can inspect every line of code on GitHub (see the LICENSE file for usage terms).",
