...
| `hotkey.trigger_set` | The trigger the tap now listens for, as a slug: `fn`, `modifier:54`, `key:49+0x80000`, `mouse:3`. Written at launch and on every change. `hotkey.press` carries the same slug. |
